...
class PagesController extends AppController
{
        ...
        if($this->request->isAjax()) {
            ...
            if($this->request->is('post')) {
                ...
                if($query) {
                    ...
                    $result = json_encode(array('success' => 0, 'message' => 'Email already exist'));
                ...
                if($this->Users->save($user)) {
                    ...
                    $result = json_encode(array('success' => 1, 'message' => 'You are now registered'));
    ...
    public function thankyou() {
        ...
        $this->set('redirect', $this->Auth->redirectUrl(['controller' => 'users', 'action' => 'index']));
    }
